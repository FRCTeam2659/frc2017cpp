...
void GripPipeline::Process(cv::Mat& source0){
	...
	double rgbThresholdRed[] = {0.0, 154.91467576791808};
	double rgbThresholdGreen[] = {173.13399280575538, 255.0};
	double rgbThresholdBlue[] = {0.0, 164.70563139931744};
	...
	//Step HSL_Threshold0:
	//input
	cv::Mat hslThresholdInput = maskOutput;
	double hslThresholdHue[] = {0.0, 98.60068259385666};
	double hslThresholdSaturation[] = {55.03597122302158, 255.0};
	double hslThresholdLuminance[] = {94.01978417266189, 255.0};
